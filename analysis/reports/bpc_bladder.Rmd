...
gg_timing_all <- dft_timing %>% 
  ...
  mutate(interval = beautify_strings(interval, dict = dict_timing_vars)) %>%
...
The following plots show four time intervals relative to the diagnosis date in the entire cohort:

1. Time (years) from diagnosis to the first next generation sequencing test.
