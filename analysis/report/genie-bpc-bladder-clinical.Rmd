...
Here we assume that a diagnosis of stage 2 implies MIBC right at the time of diagnosis, regardless of what the medical oncologist notes say.  This smooths over the data problems in the previous plot, which may or may not be a service to readers of our paper.
