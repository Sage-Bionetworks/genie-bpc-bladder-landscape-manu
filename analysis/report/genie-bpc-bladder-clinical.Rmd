...
Work in progress - statistics on those participants who did not get a first line, second line, etc.
...
```{r}
# Will have to redo the split - not a huge deal.
```
...
```{r}
# Print the split therapies here.
```
