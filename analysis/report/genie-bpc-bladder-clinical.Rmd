...
2. A drug on a list, mostly including platinum based chemotherapies (see appnedix to this report for full list).

While neoadjuvant therapy is often defined relative to a primary surgery, a limitation in the BPC data is that we cannot tell the difference between transurethral bladder tumor resection (TURBT) and radical cystectomy.  This motivates the use of distant metastasis as a marker.
