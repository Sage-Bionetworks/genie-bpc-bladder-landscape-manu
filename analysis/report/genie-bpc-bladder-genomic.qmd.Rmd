...
- The naive TMB distribution of BPC data tends to be high, we will dig into this more below.
...
The following table states the median TMB by institution/sample_type:

```{r, include = T}
ft_median_tmb
```

And the following table states the proportion of samples over 10 mut/Mb by site:
